# Image Generation Capability Benchmark Work Package
...
Generate and edit product, brand, scene, thumbnail, and reference visuals.

## Current Implementation

```text
No production generator connected; V1 uses uploaded photos and generated placeholder frames.
```

Current status:

```text
missing-production-provider
```

## Benchmark Target

Measure prompt adherence, product consistency, typography, editability, cost, local viability, and automation.
...
- ComfyUI
- FLUX local/dev workflows
- Stable Diffusion WebUI Forge

### Reputable Free Services

- free tiers from reputable image providers if privacy-safe
