# Full Body Animation Capability Benchmark Work Package
...
Animate Emma full-body movement while preserving identity and proportions.
...
Measure body consistency, pose control, motion naturalness, clothing stability, and identity drift.
...
- AnimateDiff/ComfyUI workflows
- pose-guided video workflows
- Wan/VACE-style video editing

### Reputable Free Services

- open-source pose/motion tools

### Reputable Paid Services

- paid human motion video platforms
