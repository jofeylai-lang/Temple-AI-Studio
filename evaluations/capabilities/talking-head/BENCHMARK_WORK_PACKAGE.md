# Talking Head Capability Benchmark Work Package
...
Animate Emma or presenter head/face for spoken content.

## Current Implementation

```text
Not in production; prior experiments are not active V1 inputs.
```
...
Measure identity preservation, expression naturalness, head motion, artifacts, and runtime.
...
- open-source demos only when privacy-safe

### Reputable Paid Services

- paid avatar/talking-head APIs if clearly superior
