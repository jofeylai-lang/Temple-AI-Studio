# Character Training Capability Benchmark Work Package
...
Create durable Emma visual and voice identity assets.

## Current Implementation

```text
Not started; requires approved Emma source material.
```

Current status:

```text
blocked-by-source-material
```

## Benchmark Target

Measure training data requirement, identity fidelity, update cost, privacy, and reproducibility.
...
- LoRA training
- DreamBooth-style workflows
- GPT-SoVITS voice training

### Reputable Free Services

- free training notebooks where license/privacy permit

### Reputable Paid Services

- paid custom character/voice training services
