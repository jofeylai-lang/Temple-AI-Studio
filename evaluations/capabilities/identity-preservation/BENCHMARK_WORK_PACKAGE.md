# Identity Preservation Capability Benchmark Work Package
...
Preserve Emma or product identity across scenes, poses, outfits and environments.

## Current Implementation

```text
Governance defined; no automated identity scorer implemented.
```
...
Measure face/body/product consistency, style variance tolerance, and false accept/reject rate.
...
- face embedding checks
- CLIP-style similarity
- ComfyUI reference workflows
- IP-Adapter/InstantID-style workflows
...
- paid vision evaluation APIs if materially better
