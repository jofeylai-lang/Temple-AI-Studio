# TTS Capability Benchmark Work Package
...
Generate narration from approved scripts.

## Current Implementation

```text
V1 uses text narration files; no audio synthesis connected.
```
...
Measure naturalness, Traditional Chinese pronunciation, speed, cost, and automation.
...
- free TTS services where terms/privacy permit
