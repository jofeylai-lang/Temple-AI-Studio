# Editing Capability Benchmark Work Package
...
Assemble clips, subtitles, audio, pacing, transitions, CTA, and platform exports.

## Current Implementation

```text
V1 uses FFmpeg local rendering.
```
...
Measure render speed, format correctness, subtitle style, automation, maintainability, and playback reliability.
...
- MoviePy
- Remotion
- Manim for programmatic segments

### Reputable Free Services

- none preferred until local limit is proven

### Reputable Paid Services

- cloud render services if local rendering becomes bottleneck
